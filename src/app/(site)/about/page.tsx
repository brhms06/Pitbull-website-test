...
const heroImg = dobermanPhotos[8];
...
export const metadata: Metadata = {
  title: 'About Us — Doberman Breeder',
  description: `Learn about ${site.name}, how we home-raise healthy, socialized Doberman puppies, and our written health guarantee.`,
};
  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle="A small, passionate breeder raising healthy, well-socialised Doberman puppies for families across the US."
        image={heroImg}
        breadcrumb="About Us"
      />
      ...
      <section className="container-page py-14 md:py-20">
        <div className="grid items-center gap-10 lg:grid-cols-2">
          <div className="overflow-hidden rounded-[2.5rem] shadow-lift ring-1 ring-black/5">
            <img src={dobermanPhotos[0]} alt="A Doberman resting comfortably" loading="lazy" className="h-full w-full object-cover" />
          </div>
          <div>
            <SectionHeading align="left" eyebrow="Our story" title={`Raising exceptional Doberman puppies since ${site.foundedYear}`} className="!mx-0" />
            <p className="mt-5 leading-relaxed text-ink/85">
              {site.name} began with a simple love for this loyal, intelligent breed. Our puppies are raised underfoot
            ...
            <div className="mt-6 rounded-2xl bg-forest-50 p-5">
              ...
              <p className="mt-1 text-sm text-ink/80">
                To raise healthy, happy, well-socialised Doberman puppies and match them with loving families —
      ...
      <section className="bg-forest-800 py-14 text-white md:py-20">
        <div className="container-page grid items-center gap-10 lg:grid-cols-2">
          <div className="overflow-hidden rounded-[2.5rem] shadow-lift lg:order-2">
            <img src={dobermanPhotos[1]} alt="A sleek Doberman" loading="lazy" className="h-full w-full object-cover" />
          </div>
          <div className="lg:order-1">
            <span className="badge inline-flex items-center gap-1.5 bg-white/15 text-white">
              <PawIcon className="h-3.5 w-3.5" /> The breed
            </span>
            <h2 className="mt-3 text-3xl font-extrabold text-white">Why families love Dobermans</h2>
            <p className="mt-4 leading-relaxed text-cream/85">
              Dobermans are one of the most loyal, intelligent breeds — confident, alert and deeply devoted
              to their people. Their athletic build and protective, trainable nature make them a wonderful
