...
const sections: Array<{ h: string; p: string[] }> = [
  {
    h: 'Who we are',
    p: [
      `${site.name} is a family-run Doberman breeder. This policy explains what personal information we collect through this website, why we collect it, and what you can do about it.`,
